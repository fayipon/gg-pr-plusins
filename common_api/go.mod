...
require (
	github.com/fayipon/gg-pr-plusins/users_rpc v0.0.0
...
replace github.com/fayipon/gg-pr-plusins/users_rpc => ../users_rpc

replace github.com/redis/go-redis/v9 v9.15.0 => github.com/redis/go-redis/v9 v9.14.0
