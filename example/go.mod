...
require (
	...
	github.com/fayipon/gg-pr-plusins/example v1.7.3
...
require (
	...
	github.com/suyuan32/simple-admin-core v1.4.3 // indirect
	github.com/suyuan32/simple-admin-example-rpc v1.7.3 // indirect
