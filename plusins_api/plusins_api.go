//	plusins_api
//
//	Description: plusins_api service
//
//	Schemes: http, https
//	Host: localhost:8081
//	BasePath: /
...
import (
	...
	"github.com/fayipon/gg-pr-plusins/plusins_api/internal/handler"
...
var configFile = flag.String("f", "etc/plusins_api.yaml", "the config file")
